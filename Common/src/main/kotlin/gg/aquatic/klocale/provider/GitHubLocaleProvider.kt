...
class GitHubLocaleProvider<M : Message<M>>(
    val owner: String,
    val repo: String,
    val path: String,
    val branch: String = "main",
    val serializer: LocaleSerializer<String, M>,
    private val client: HttpClient = HttpClient.newBuilder()
        .connectTimeout(Duration.ofSeconds(10))
        .build()
) : LocaleProvider<M> {

    private val rawUrl = "https://raw.githubusercontent.com/$owner/$repo/$branch/$path"
